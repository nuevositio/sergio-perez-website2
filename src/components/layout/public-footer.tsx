...
const social = [
  {
    href: "https://instagram.com/sp.gestioncultural",
    label: "Instagram",
    icon: (
  ...
  {
    href: "https://facebook.com/sp.gestioncultural",
    label: "Facebook",
    icon: (
      <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current" aria-hidden="true">
  ...
  {
    href: "https://www.linkedin.com/in/spgestioncultural/",
    label: "LinkedIn",
    icon: (
      <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current" aria-hidden="true">
  ...
  },
  {
    ...
    icon: (
      <Image
        src="https://themesh.art/wp-content/uploads/2026/01/cropped-mesh-2026-logo-squared-black-and-purple-Photoroom.png"
        alt=""
        width={20}
        height={20}
      ...
      <div className="mx-auto w-full max-w-6xl px-6 py-10">
        <div className="mb-8 flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
          ...
          <nav className="flex flex-wrap gap-x-5 gap-y-2">
            {nav.map((link) => (
              <Link key={link.href} href={link.href} className="text-sm text-zinc-600 hover:text-zinc-900">
                {link.label}
              </Link>
            ))}
          </nav>
